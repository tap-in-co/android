...
public class URLs {
    ...
    public static final String MAIN_URL = "https://tapforall.com/staging/tap-in/";
    ...
    public static final String GET_HOME_DATA = MAIN_URL + "businessinfo/index.php?businessID=0";
